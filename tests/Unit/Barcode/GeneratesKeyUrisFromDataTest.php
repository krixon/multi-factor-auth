...
class GeneratesKeyUrisFromDataTest extends TestCase
{
     ...
     */
    public function testGeneratesExpectedKeyUri(Data $data, bool $urlEncode, string $expected) : void
    {
        $uri = $this->impl()->generateKeyURI($data, $urlEncode);
    ...
    public function expectedUriProvider() : array
    {
        ...
        return [
            ...
            // check urlDecode === false keeps URL raw
            [
                $timeData->withAlgorithm(Algorithm::sha512()),
                false,
                'otpauth://totp/Test%20Issuer%3Adave.lister%40example.com?' .
                'secret=1234567890&issuer=Test%20Issuer&digits=6&period=30&algorithm=SHA512'
            ],
        ];
    }
