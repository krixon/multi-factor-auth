...
{
    public static function assertByteCount(int $expectedByteCount, string $string, string $message = '')
    {
        static::assertThat($string, new Constraint\ByteCount($expectedByteCount), $message);
    }


    public static function assertByteCountGreaterThanOrEqualTo(int $minByteCount, string $string, string $message = '')
    {
